function contactsController($scope, $http) {
	...
	$scope.url = "/UberDash/protected/contacts/";
	...
	$scope.createContact = function(newContactForm) {
		...
		$http.post(url, $.param($scope.contact), config).success(function(data) {
	...
	$scope.updateContact = function(updateContactForm) {
		...
		$http.put(url, $scope.contact, config).success(function(data) {
